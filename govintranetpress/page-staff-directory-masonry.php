			...
			<div class="col-lg-12 col-md-12 col-sm-12">
					...
					foreach ($userq as $u){ 
						...
						if ( ( ($usergrade['slug'] == $grade) && ($grade ) ) || (!$grade)  ) {
							...
							if ($fulldetails){
								$html .= "<div class='pgrid-item'><div class='media well well-sm'><a href='".site_url()."/staff/".$user_info->user_nicename."/'>".$avatarhtml."</a><div class='media-body'><p><a href='".site_url()."/staff/".$user_info->user_nicename."/'><strong>".$displayname."</strong>".$gradedisplay."</a><br>";
						...
						<?php if ( get_user_meta($userid ,'user_job_title',true )) : 
							...
							<?php if ( get_user_meta($userid ,'user_mobile',true ) && $showmobile ) : 
								...
								$html .= "<div class='pgrid-item'><div class='indexcard'><a href='".site_url()."/staff/".$user_info->user_nicename."/'><div class='media'>".$avatarhtml."<div class='media-body'><strong>".$displayname."</strong>".$gradedisplay."<br>";
								// display team name(s)
								$poduser = new Pod ('user' , $userid);
								$terms = $poduser->get_field('user_team');
								unset($poduser);
...
?>
	...
	$output=
		'<div id="container"><div class="grid-sizer"></div>'.$html."</div>";
	echo $output;
	echo "</div>";
	}
?>
